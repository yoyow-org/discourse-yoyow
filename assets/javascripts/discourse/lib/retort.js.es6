...
const disabledCategories = _.compact(_.invoke(Discourse.SiteSettings.yoyow_retort_disabled_categories.split('|'), 'toLowerCase'))
...
export default Ember.Object.create({
  ...
  updateRetort (postId, retort) {
    return ajax(`/yoyow_retorts/${postId}.json`, {
      type: 'POST',
      data: { retort: retort }
  ...
  setPicker (picker) {
    ...
    this.set('picker.limitOptions', Discourse.SiteSettings.yoyow_retort_limited_emoji_set)
  }
})
